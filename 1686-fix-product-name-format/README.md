<h2><a href="https://leetcode.com/problems/fix-product-name-format">Fix Product Name Format</a></h2> <img src='https://img.shields.io/badge/Difficulty-Easy-brightgreen' alt='Difficulty: Easy' /><hr><p>Table: <code>Sales</code></p>
